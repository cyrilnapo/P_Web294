<template>
  <main>
    ...
    <div v-if="isAuthenticated">
      ...
      <button @click="navigateToAddBook" class="add-book-button">Ajouter un livre</button>
    </div>
    <p v-else class="error-message">
      Vous n'êtes pas connecté. Veuillez vous connecter pour voir vos livres.
    </p>
  </main>
...
const fetchBooks = () => {
  ...
  BookService.getBooks()
    .then((response) => {
      books.value = response.data.data.filter((book) => book.userId === userId.value)
      loading.value = false
